...
new Vue({
    ...
    data() {
        return {
            currentIcon: 'firefox',
            currentInlineIcon: 'inline-firefox',
            currentSize: '150',
    ...
    computed: {
        ...
        svgs() {
            return {
                'inline-firefox': [
                    './img/firefox.svg',
                    `<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 953.37 984">
                        <defs>
                ...
                'inline-safari': [
                    ...
                    `<svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="250.076" height="248.707" viewBox="0 0 66.166 65.804">
                        <defs>
                            ...
                            <linearGradient id="a">
                                <stop offset="0" stop-color="#36d56e"/>
                                <stop offset="1" stop-color="#a4e0b2"/>
                            </linearGradient>
                            <linearGradient xlink:href="#a" id="d" x1="412.975" y1="237.608" x2="412.975" y2="59.392" gradientUnits="userSpaceOnUse" gradientTransform="matrix(.35154 0 0 .35154 206.79 159.773)"/>
                            <radialGradient xlink:href="#b" id="e" cx="413.061" cy="136.818" fx="413.061" fy="136.818" r="82.125" gradientUnits="userSpaceOnUse" gradientTransform="matrix(.38143 0 0 .38143 194.545 155.58)"/>
